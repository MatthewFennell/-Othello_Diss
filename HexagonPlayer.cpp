...
void HexagonPlayer::mouseHandler(int event, int x, int y, int flags, void * param)
{
...
int* HexagonPlayer::getMove(Mat imageOfBoard, HexagonBoard board)
{
